...
export default function CardR({ img, title, description }: { img: string; title: string; description: string }) {
    return (
        <motion.div
      ...
      >
        ...
        />
        <ArrowUpOutlined className=" text-3xl absolute  text-indigo-400 top-0 right-0 rotate-45 mt-5 mr-5 group-hover:text-indigo-200 group-hover:mt-0 group-hover:mr-0 ease-in-out duration-300" />
